...
["Zeus Additions - Resupply", "Spawn Ammo Resupply for Units (Selection)", {
    ...
    ],
    {
        ...
        _results params ["_selected", "_emptyInventory"];
        _args params ["_pos", "_object"];
        _selected params ["_sides", "_groups", "_players"];
        ...
        private _weapons = ((call CBA_fnc_players) select {side _x in _sides || {group _x in _groups} || {_x in _players}}) apply {weapons _x};
        _weapons = flatten _weapons;
        ...
        // Spawn ammo GUI
        [_weapons] spawn FUNC(createResupplyGUI);
    }, {
        ["Aborted"] call zen_common_fnc_showMessage;
        playSound "FD_Start_F";
    }, [_pos, _object]] call zen_dialog_fnc_create;
