...
GVAR(magsTotal) = [];
private _temp = [GVAR(545x39),GVAR(762x39),GVAR(762x54R),GVAR(oddBLU),GVAR(Stanag556),GVAR(Misc556),GVAR(Belt556),GVAR(QBZ58KH65),GVAR(MX65),GVAR(All762),GVAR(Belt762),GVAR(12G),GVAR(PistolBLU),GVAR(PistolRED),GVAR(UGLBLU),GVAR(UGLRED),GVAR(MATBLU),GVAR(MATRED),GVAR(HATRED),GVAR(AABLU),GVAR(AARED)];
